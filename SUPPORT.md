...
| [Cross-agent continuation](docs/cross-agent-continuation.md) | Planned quota/outage handoff, fidelity, and support boundaries |
...
- Implementing features beyond Phase 1 scope (including cross-agent
  continuation and universal agent configuration); roadmap discussion is welcome
