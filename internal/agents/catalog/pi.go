...
//
// Promoted on 2026-08-17 when native Windows and macOS AGENT-PROBE-V1
// artifacts agreed on sessions/<slug>/<slug>-<uuid-v4>.jsonl and first-line
// keys cwd, id, timestamp, type, version. The index reads the type=session
// header only. Later tree lines are not a transcript. Resume and fork stay
