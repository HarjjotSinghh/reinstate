...
func TestV040RC11AcceptancePromptContracts(t *testing.T) {
	body := read(t, "docs/testing/v0.4.0-rc.11-agent-verification-prompts.md")
	for _, value := range []string{
		"v0.4.0-rc.11",
		"Why RC11 exists",
		"V040RC11",
		"PHASE4-RC11-FINAL-RECONCILIATION-V1",
		"phase4_rc11_tagged_artifact_acceptance",
		"test/v0.4.0-rc.11-macos-arm64-report",
		"test/v0.4.0-rc.11-windows-amd64-report",
		"Go 1.25.13",
		"2.1.219",
		"2.1.229",
		"0.133.0",
		...
		if !strings.Contains(body, value) {
			t.Errorf("v0.4.0-rc.11 acceptance prompts missing %q", value)
		}
	}
}

func TestV040RC10AcceptancePromptContracts(t *testing.T) {
	body := read(t, "docs/testing/v0.4.0-rc.10-agent-verification-prompts.md")
	for _, value := range []string{
		"v0.4.0-rc.10",
		"Why RC10 exists",
		"V040RC10",
		"PHASE4-RC10-FINAL-RECONCILIATION-V1",
		"phase4_rc10_tagged_artifact_acceptance",
		"test/v0.4.0-rc.10-macos-arm64-report",
		"test/v0.4.0-rc.10-windows-amd64-report",
		"Go 1.25.13",
		"2.1.219",
		"2.1.229",
		"0.133.0",
		...
		if !strings.Contains(body, value) {
			t.Errorf("v0.4.0-rc.10 acceptance prompts missing %q", value)
		}
	}
}
