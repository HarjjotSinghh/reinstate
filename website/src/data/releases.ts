export const releaseHistory = [
  {
    version: 'v0.6.0-rc.1',
    // Placeholder date; W8 sets the real signed-tag date. Kept as a valid
    // ISO date (not a literal "DD") because product.currentReleaseDate must
    // equal this and /changelog runs that field through Intl.DateTimeFormat.
    date: '2026-09-05',
    summary:
