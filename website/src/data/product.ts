export const product = {
  ...
  currentRelease: 'v0.5.0-rc.3',
  currentReleaseUrl:
    'https://github.com/HarjjotSinghh/reinstate/tree/v0.5.0-rc.3',
  currentReleaseDate: '2026-08-20',
  initialPublicReleaseDate: '2026-07-25',
  stableRelease: 'v0.4.0',
  releaseStatus: 'v0.5.0-rc.3 candidate · dual-platform tagged-artifact acceptance pending',
