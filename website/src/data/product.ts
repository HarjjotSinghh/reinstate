export const product = {
  ...
  currentRelease: 'v0.3.0-rc.4',
  currentReleaseUrl:
    'https://github.com/HarjjotSinghh/reinstate/tree/v0.3.0-rc.4',
  currentReleaseDate: '2026-08-08',
  initialPublicReleaseDate: '2026-07-25',
  stableRelease: 'v0.2.0',
  releaseStatus: 'v0.3.0-rc.4 candidate · tagged-artifact acceptance pending',
