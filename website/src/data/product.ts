export const product = {
  ...
  currentRelease: 'v0.2.0-rc.2',
  currentReleaseUrl:
    'https://github.com/HarjjotSinghh/reinstate/tree/v0.2.0-rc.2',
  currentReleaseDate: '2026-08-02',
  initialPublicReleaseDate: '2026-07-25',
  stableRelease: 'v0.1.0',
  releaseStatus: 'v0.2.0-rc.2 prerelease',
