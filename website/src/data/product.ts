export const product = {
  ...
  currentReleaseUrl:
    'https://github.com/HarjjotSinghh/reinstate/tree/v0.4.0',
  currentReleaseDate: '2026-08-16',
  initialPublicReleaseDate: '2026-07-25',
  stableRelease: 'v0.4.0',
  releaseStatus: 'v0.4.0 stable · dual-platform tagged-artifact acceptance PASS',
