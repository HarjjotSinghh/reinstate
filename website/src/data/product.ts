export const product = {
  ...
  currentRelease: 'v0.5.0-rc.2',
  currentReleaseUrl:
    'https://github.com/HarjjotSinghh/reinstate/tree/v0.5.0-rc.2',
  currentReleaseDate: '2026-08-19',
  initialPublicReleaseDate: '2026-07-25',
  stableRelease: 'v0.4.0',
  releaseStatus: 'v0.5.0-rc.2 candidate · dual-platform tagged-artifact acceptance pending',
