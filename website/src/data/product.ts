export const product = {
  ...
  currentRelease: 'v0.4.0-rc.7',
  currentReleaseUrl:
    'https://github.com/HarjjotSinghh/reinstate/tree/v0.4.0-rc.7',
  currentReleaseDate: '2026-08-15',
  initialPublicReleaseDate: '2026-07-25',
  stableRelease: 'v0.3.0',
  releaseStatus: 'v0.4.0-rc.7 candidate · tagged-artifact acceptance pending',
