export const product = {
  ...
  currentRelease: 'v0.5.0',
  currentReleaseUrl:
    'https://github.com/HarjjotSinghh/reinstate/tree/v0.5.0',
  currentReleaseDate: '2026-08-21',
  initialPublicReleaseDate: '2026-07-25',
  stableRelease: 'v0.5.0',
  releaseStatus: 'v0.5.0 stable · dual-platform tagged-artifact acceptance PASS on v0.5.0-rc.6',
