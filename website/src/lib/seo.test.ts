...
describe('SEO product truth', () => {
  it('protects the current stable product boundary', () => {
    ...
    expect(product.releaseStatus).toBe(
      'v0.6.0-rc.2 candidate · stable remains v0.5.1 · v0.6.0-rc.1 tagged Windows run ended 201/216, its defects fixed here · native Windows tagged-artifact acceptance pending, macOS deferred',
    );
