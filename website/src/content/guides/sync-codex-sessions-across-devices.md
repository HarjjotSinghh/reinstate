...
The current public installer pins candidate `v0.6.0-rc.3`, whose
...
- The installer-pinned `v0.6.0-rc.3` candidate's tagged-artifact acceptance
...
is `v0.6.0-rc.3` for the currently pinned installer (stable remains
