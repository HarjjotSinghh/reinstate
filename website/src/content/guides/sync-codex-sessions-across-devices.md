...
The current public installer pins candidate `v0.6.0-rc.2`, whose
...
- The installer-pinned `v0.6.0-rc.2` candidate's tagged-artifact acceptance
...
is `v0.6.0-rc.2` for the currently pinned installer (stable remains
