...
prerequisites:
  ...
  - "Reinstate v0.2.0-rc.2 on a compatible device with Claude Code or Codex CLI"
...
This guide connects Reinstate `v0.2.0-rc.2` to an existing Amazon S3 bucket.
...
- Session resume remains **same-vendor**: Claude Code to Claude Code and Codex
  CLI to Codex CLI.
- Reinstate v0.2.0-rc.2 is a pre-1.0 release candidate. Two-device Phase 1 acceptance
...
**Expected result:** the pinned installer reports `v0.2.0-rc.2`. Before
