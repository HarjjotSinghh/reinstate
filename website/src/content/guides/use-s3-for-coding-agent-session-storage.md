...
prerequisites:
  ...
  - "Reinstate (the installer's v0.6.0-rc.6 candidate; stable is v0.5.1) on a compatible device with Claude Code or Codex CLI"
...
This guide connects Reinstate — the installer's `v0.6.0-rc.6` candidate;
...
**Expected result:** the pinned installer reports `v0.6.0-rc.6`, the
