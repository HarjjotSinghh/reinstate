...
prerequisites:
  ...
  - "Reinstate (stable v0.5.1, or the installer's v0.6.0-rc.3 candidate) plus a tested Claude Code or Codex CLI version on both computers"
...
the installer's `v0.6.0-rc.3` candidate, whose tagged-artifact acceptance is
