...
- Apple Silicon macOS or native 64-bit Windows for mandatory RC2 acceptance
...
Both bootstraps pin `v0.3.0-rc.2`, verify the exact tagged canonical installer
...
those environments are optional and unverified for v0.3.0-rc.2.
