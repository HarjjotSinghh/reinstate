...
Reinstate `v0.2.0-rc.2` is a pre-1.0 release candidate; Claude Code and Codex
...
Require Reinstate `0.2.0-rc.2` on both candidate-test devices. Correct the destination
