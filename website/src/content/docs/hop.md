...
description: "See how Reinstate Hop's passwordless sign-in, device pairing, encrypted locker, verification, and daemon work in the v0.6.0-rc.1 candidate."
order: 17
...
> `v0.6.0-rc.1` release candidate, not yet a stable claim — stable remains
