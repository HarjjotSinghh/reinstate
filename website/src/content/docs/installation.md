...
require `rein version --json` to report `v0.3.0-rc.4`. The bootstrap verifies
...
> **Release status:** `v0.3.0-rc.4` is a pre-1.0 candidate whose tagged-artifact
...
- Apple Silicon macOS or native Windows x64 for mandatory RC4 acceptance, or
