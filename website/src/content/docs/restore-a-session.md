...
> sessions restore to Codex. RC8 does not translate native transcripts,
...
- Reinstate `v0.1.0-rc.8` installed and initialized on the destination.
...
Claude session tree is not equivalent. For Codex, RC8 preserves the native
