...
> sessions restore to Codex. RC6 does not translate native transcripts,
...
- Reinstate `v0.1.0-rc.6` installed and initialized on the destination.
...
source; Phase 3 environment verification remains roadmap work.
...
Claude session tree is not equivalent. For Codex, RC6 preserves the native
