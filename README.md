...
> the published release candidate `v0.1.0-rc.8`.
>
...
Both bootstraps pin and verify `v0.1.0-rc.8`, install without elevation, and
...
RC8 waits at most 30 seconds for replacement approval; set
...
RC8 refuses to overwrite an initialized home by default. The explicit
...
RC8 verifies the encrypted remote manifest during additional-device `init`
