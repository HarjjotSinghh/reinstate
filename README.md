...
> **Platform boundary:** the public installers pin candidate `v0.5.0-rc.4`.
...
### Install the v0.5.0-rc.4 candidate
...
Both bootstraps pin and verify `v0.5.0-rc.4`, install without elevation, and
...
The GitHub Release and `reinstate.dev` installers pin `v0.5.0-rc.4`. The Homebrew
