...
Current release candidate `v0.4.0-rc.6` adds Phase 4 explicit structured
...
`v0.4.0-rc.1` through `v0.4.0-rc.5` were published and failed
physical acceptance; rc.6 carries those product fixes. Dual-platform
...
> **Platform boundary:** the public installers pin candidate `v0.4.0-rc.6`.
...
### Install the v0.4.0-rc.6 candidate
...
Both bootstraps pin and verify `v0.4.0-rc.6`, install without elevation, and
...
The handoff columns describe the `v0.4.0-rc.6` candidate and remain subject to
...
| **4** | Structured cross-agent handoffs (`v0.4.0-rc.6` candidate) | 🚧 |
