...
switcher, same-vendor native resume/fork, and Phase 3 verified resume. A
...
> **Platform boundary:** the public installers pin candidate `v0.5.0-rc.3`.
...
### Install the v0.5.0-rc.3 candidate
...
Both bootstraps pin and verify `v0.5.0-rc.3`, install without elevation, and
...
The GitHub Release and `reinstate.dev` installers pin `v0.5.0-rc.3`. The Homebrew
...
| [Features and commands](docs/features.md) | What shipped in v0.1.0 through v0.4.0 |
