...
Current release candidate `v0.4.0-rc.4` adds Phase 4 explicit structured
...
`v0.4.0-rc.1`, `v0.4.0-rc.2`, and `v0.4.0-rc.3` were published and failed
physical acceptance; rc.4 carries those product fixes. Dual-platform
...
> **Platform boundary:** the public installers pin candidate `v0.4.0-rc.4`.
...
### Install the v0.4.0-rc.4 candidate
...
Both bootstraps pin and verify `v0.4.0-rc.4`, install without elevation, and
...
The handoff columns describe the `v0.4.0-rc.4` candidate and remain subject to
...
| **4** | Structured cross-agent handoffs (`v0.4.0-rc.4` candidate) | 🚧 |
