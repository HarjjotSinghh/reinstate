...
Current release candidate `v0.3.0-rc.5` adds Phase 3 verified resume. Its
...
| **Verified resume** | `v0.3.0-rc.5` checks the workspace, agent, capabilities, and recognized runtimes before launch |
...
Included in the `v0.3.0-rc.5` release candidate (tagged-artifact acceptance
pending):
...
> **Platform boundary:** the public installers pin candidate `v0.3.0-rc.5`.
...
The `v0.3.0-rc.5` candidate adds an `environment` report to `inspect` and native
...
### Install the v0.3.0-rc.5 candidate
...
Both bootstraps pin and verify `v0.3.0-rc.5`, install without elevation, and
...
| **3** | Verified resume (included in `v0.3.0-rc.5`; tagged-artifact acceptance pending) | 🚧 |
| **4** | Portable handoffs | 📋 |
