...
(150/150 on both
devices); the public installers pin candidate `v0.6.0-rc.2`, whose native
...
> installers pin candidate `v0.6.0-rc.2`, which is certified on native Windows
...
The GitHub Release and `reinstate.dev` installers pin `v0.6.0-rc.2`. The Homebrew
...
| **6C** | Cloud continuity — Hop hosted sync, device registry, daemon (candidate `v0.6.0-rc.2`) | 🚧 |
