...
(150/150 on both
devices); the public installers pin candidate `v0.6.0-rc.7`, whose native
...
> installers pin candidate `v0.6.0-rc.7`, whose native Windows x64 acceptance
...
### Install the v0.6.0-rc.7 candidate
...
Both bootstraps pin and verify `v0.6.0-rc.7`, install without elevation, and
...
The GitHub Release and `reinstate.dev` installers pin `v0.6.0-rc.7`. The Homebrew
...
| **6C** | Cloud continuity — Hop hosted sync, device registry, daemon (candidate `v0.6.0-rc.7`) | 🚧 |
