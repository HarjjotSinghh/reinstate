...
**Prompt version:** 9
**Pinned Reinstate release:** `v0.6.0-rc.3`
...
public bootstrap pinned to `v0.6.0-rc.3`. Never substitute `latest`, `main`, or
another version.
...
3. Download the bootstrap to a temporary file and inspect it before execution.
   ...
   - binary downloads restricted to
     `https://github.com/HarjjotSinghh/reinstate/releases/download/v0.6.0-rc.3/`.
