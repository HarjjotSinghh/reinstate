...
**Prompt version:** 9
**Pinned Reinstate release:** `v0.4.0-rc.6`
...
public bootstrap pinned to `v0.4.0-rc.6`. Never substitute `latest`, `main`, or
another version.
...
3. Download the bootstrap to a temporary file and inspect it before execution.
   ...
   - binary downloads restricted to
     `https://github.com/HarjjotSinghh/reinstate/releases/download/v0.4.0-rc.6/`.
