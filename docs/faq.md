...
configuration. Release candidate `v0.3.0-rc.1` also implements Phase 3 verified
...
The `v0.3.0-rc.1` candidate uses a private derived index at
...
`v0.3.0-rc.1`; its Apple Silicon macOS/native Windows x64 acceptance is pending,
...
In the `v0.3.0-rc.1` candidate, `rein inspect`, native dry-runs,
...
Phase 3 verified resume is included in `v0.3.0-rc.1`; tagged-artifact acceptance
is pending. No stable `v0.3.0` claim is made.
