...
configuration. Release candidate `v0.3.0-rc.2` also implements Phase 3 verified
...
The `v0.3.0-rc.2` candidate uses a private derived index at
...
`v0.3.0-rc.2`; its Apple Silicon macOS/native Windows x64 acceptance is pending,
...
In the `v0.3.0-rc.2` candidate, `rein inspect`, native dry-runs,
...
Phase 3 verified resume is included in `v0.3.0-rc.2`; tagged-artifact acceptance
