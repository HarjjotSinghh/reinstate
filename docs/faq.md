...
macOS and native Windows x64. Candidate `v0.4.0-rc.3` adds Phase 4 explicit
...
Stable `v0.3.0` and candidate `v0.4.0-rc.3` use a private derived index at
...
`v0.4.0-rc.3`; its dual-platform tagged-artifact acceptance is pending and
...
and unverified. Candidate `v0.4.0-rc.3` adds structured handoff, but its
