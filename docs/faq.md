...
configuration. Release candidate `v0.3.0-rc.3` also implements Phase 3 verified
...
The `v0.3.0-rc.3` candidate uses a private derived index at
...
`v0.3.0-rc.3`; its Apple Silicon macOS/native Windows x64 acceptance is pending,
...
In the `v0.3.0-rc.3` candidate, `rein inspect`, native dry-runs,
...
Phase 3 verified resume is included in `v0.3.0-rc.3`; tagged-artifact acceptance
