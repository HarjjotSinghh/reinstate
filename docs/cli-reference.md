...
Public installers pin candidate `v0.4.0-rc.4`, including the Phase 1/2 surface,
...
includes the `v0.4.0-rc.4` structured-handoff surface.
...
## Phase 4 structured handoff (`v0.4.0-rc.4`)
