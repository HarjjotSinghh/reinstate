...
Public installers pin candidate `v0.3.0-rc.2`, including the Phase 1/2 surface
...
The command synopsis below follows `v0.3.0-rc.2`. Stable `v0.2.0` does not
...
access, or a backend. Stable `v0.2.0` used the Phase 2 v1 index. `v0.3.0-rc.2`
...
Review the plan with `--dry-run --json`. `v0.3.0-rc.2` also includes
...
## Phase 3 verified resume (`v0.3.0-rc.2`)

Phase 3 is included in candidate `v0.3.0-rc.2`; tagged-artifact acceptance is
