# Features and commands (v0.1.0–v0.4.0)

Stable `v0.4.0` is the current release. It includes every shipped surface from
Phase 1 through Phase 4. This page is the command map. Details live in
