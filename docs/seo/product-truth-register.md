...
Reviewed candidate: `v0.6.0-rc.3`, dated 2026-09-07; native Windows x64
...
`v0.6.0-rc.1` (2026-09-06), and `v0.6.0-rc.2` (2026-09-07, tagged Windows run
ended device verdict `FAIL`, 203/215 required rows, on a Cursor CLI
store-schema defect this candidate fixes) were all published candidates that
were superseded without stable promotion; their content ships inside
`v0.6.0-rc.3`.
...
| Current release | Stable is `v0.5.1`, dated 2026-08-21. `v0.6.0-rc.3`, dated 2026-09-07, is the current candidate awaiting native Windows x64 tagged-artifact acceptance (macOS deferred under ADR 0005). | `website/src/data/product.ts`, `CHANGELOG.md` section `[0.6.0-rc.3]`, release history |
