...
Reviewed release: `v0.5.0-rc.3` candidate; public installers pin this tag.
...
| Current release | `v0.5.0-rc.3` candidate (stable remains `v0.4.0`; dual-platform tagged-artifact acceptance pending) | changelog, release history, compatibility data |
