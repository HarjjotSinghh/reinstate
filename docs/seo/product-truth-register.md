...
Reviewed release: `v0.3.0-rc.3` (candidate acceptance pending; stable remains `v0.2.0`)
...
| Current release | `v0.3.0-rc.3` candidate, acceptance pending; `v0.2.0` remains stable | changelog, release history, compatibility data |
...
1. `v0.3.0-rc.3` needs completed Apple Silicon macOS and native Windows x64
