...
Reviewed candidate: `v0.6.0-rc.5`, dated 2026-09-07; native Windows x64
...
fixed), and `v0.6.0-rc.4` (2026-09-07, tagged Windows run ended device
...
this candidate) were all published candidates that were superseded without
stable promotion; their content ships inside `v0.6.0-rc.5`.
...
| Current release | Stable is `v0.5.1`, dated 2026-08-21. `v0.6.0-rc.5`, dated 2026-09-07, is the current candidate awaiting native Windows x64 tagged-artifact acceptance (macOS deferred under ADR 0005). | `website/src/data/product.ts`, `CHANGELOG.md` section `[0.6.0-rc.5]`, release history |
