...
Reviewed candidate: `v0.6.0-rc.4`, dated 2026-09-07; native Windows x64
...
store-schema defect `v0.6.0-rc.3` fixed), and `v0.6.0-rc.3` (2026-09-07,
tagged Windows run ended device verdict `FAIL`, 201/215 required rows, on a
Pi reader defect and a Qwen Code version-compatibility block this candidate
fixes) were all published candidates that were superseded without stable
promotion; their content ships inside `v0.6.0-rc.4`.
...
| Current release | Stable is `v0.5.1`, dated 2026-08-21. `v0.6.0-rc.4`, dated 2026-09-07, is the current candidate awaiting native Windows x64 tagged-artifact acceptance (macOS deferred under ADR 0005). | `website/src/data/product.ts`, `CHANGELOG.md` section `[0.6.0-rc.4]`, release history |
