...
| Current release | `v0.1.0-rc.6`, pre-1.0 release candidate; no stable release yet | changelog, release history, compatibility data |
...
1. Native Windows RC6, macOS amd64, WSL2, and physical two-device acceptance
   need completed evidence before stable-support language.
2. No stable release exists; `v0.1.0-rc.6` remains the truthful public status.
