...
- Primary audience: developers and coding agents that need current RC6 syntax
...
- Current capabilities used: only commands registered by the RC6 Cobra command
