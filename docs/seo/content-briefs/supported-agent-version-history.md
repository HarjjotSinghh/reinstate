...
- Secondary questions: when were inclusive ranges introduced; did RC4–RC8 change the range; what happens outside it; does source compatibility equal physical certification?
...
- Version: current release `v0.1.0-rc.8`.
