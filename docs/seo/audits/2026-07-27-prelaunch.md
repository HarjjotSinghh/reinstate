...
2. Native macOS, macOS amd64, Windows, WSL2, and complete two-device RC8
...
- Product-truth review corrected two subtle overclaims: RC5 performed a
  ...
  `${WORK:<alias>}` primitive is not wired into RC8 config or adapters.
...
3. Complete the manual browser matrix and RC8 physical platform/two-device
