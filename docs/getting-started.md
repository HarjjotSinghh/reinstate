...
Release candidate `v0.3.0-rc.1` additionally implements Phase 3 verified
...
### Install v0.3.0-rc.1 on macOS, Linux, or WSL2
...
### Install v0.3.0-rc.1 on native Windows PowerShell
...
The `v0.3.0-rc.1` candidate includes a deterministic `environment` report in
...
That v2 path describes `v0.3.0-rc.1`. Stable `v0.2.0` uses
