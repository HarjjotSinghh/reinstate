...
Release candidate `v0.4.0-rc.7` adds Phase 4 structured handoff, which
...
> **Release status:** the public installers pin candidate `v0.4.0-rc.7`.
...
### Install v0.4.0-rc.7 on macOS, Linux, or WSL2
...
### Install v0.4.0-rc.7 on native Windows PowerShell
