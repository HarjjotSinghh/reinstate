...
Release candidate `v0.4.0-rc.2` adds Phase 4 structured handoff, which
...
> **Release status:** the public installers pin candidate `v0.4.0-rc.2`.
...
### Install v0.4.0-rc.2 on macOS, Linux, or WSL2
...
### Install v0.4.0-rc.2 on native Windows PowerShell
