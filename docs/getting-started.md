...
Release candidate `v0.3.0-rc.7` additionally implements Phase 3 verified
...
> **Release status:** the public installers pin candidate `v0.3.0-rc.7`.
...
### Install v0.3.0-rc.7 on macOS, Linux, or WSL2
...
### Install v0.3.0-rc.7 on native Windows PowerShell
...
The `v0.3.0-rc.7` candidate includes a deterministic `environment` report in
...
That v2 path describes `v0.3.0-rc.7`. Stable `v0.2.0` uses
