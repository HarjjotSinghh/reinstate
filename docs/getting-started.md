...
Release candidate `v0.4.0-rc.8` adds Phase 4 structured handoff, which
...
> **Release status:** the public installers pin candidate `v0.4.0-rc.8`.
...
### Install v0.4.0-rc.8 on macOS, Linux, or WSL2
...
### Install v0.4.0-rc.8 on native Windows PowerShell
