...
Release candidate `v0.4.0-rc.9` adds Phase 4 structured handoff, which
...
> **Release status:** the public installers pin candidate `v0.4.0-rc.9`.
...
- Go 1.25.13 or newer when building the current source; and
...
### Install v0.4.0-rc.9 on macOS, Linux, or WSL2
...
### Install v0.4.0-rc.9 on native Windows PowerShell
...
That v2 path describes `v0.3.0`. Stable `v0.2.0` uses
