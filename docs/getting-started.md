...
> **Release status:** the public installers pin candidate `v0.6.0-rc.7`; stable remains `v0.5.1`.
...
The GitHub Release pins `v0.6.0-rc.7`; the tap may still list an earlier
