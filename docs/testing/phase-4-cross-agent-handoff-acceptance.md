...
installer that still pins stable `v0.3.0` or `v0.4.0-rc.1` through `v0.4.0-rc.10`.

The first ten candidates, `v0.4.0-rc.1` through `v0.4.0-rc.10`,
were published and **failed** this acceptance. `v0.4.0-rc.11` requires the
five-bullet dest first-reply in bootstrap and Windows one-line argv, records
lineage before dest Launch, recovers artifact dirs in `handoff list`, and
Materializes dest-home workspace trust. The rc.11 dispatch carries RC1
`R1`–`R6`, the RC2, RC3, RC5, RC6, RC7, RC8, RC9, RC10, and RC11 regression sets so
...
[v0.4.0-rc.8](v0.4.0-rc.8-agent-verification-prompts.md),
[v0.4.0-rc.9](v0.4.0-rc.9-agent-verification-prompts.md), and
[v0.4.0-rc.10](v0.4.0-rc.10-agent-verification-prompts.md) dispatches remain in
