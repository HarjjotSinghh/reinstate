...
Release candidate `v0.4.0-rc.6` adds Phase 4 structured handoff on top of that
...
already moved past it within a day, so `v0.4.0-rc.6` keeps `2.1.229`.
...
| Agent | Inclusive source-tested range (v0.4.0-rc.6) |
| ----- | ------------------- |
