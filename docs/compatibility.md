...
Reinstate Phase 1 (`v0.1.0`) supports **same-vendor session sync** for:
...
| `UNTESTED` | Recognizable layout, newer or unverified version | Read-only discovery + dry-run; restore needs override |
