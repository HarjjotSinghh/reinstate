...
Gemini CLI and Kimi Code CLI are T2. OpenCode is not yet a synced agent: its
encrypted-sync adapter is built and its macOS journey is recorded, but the tier
waits for the native Windows journey to be recorded too. Grok's resume and destination journeys
