...
| ------- | ------------------- | ------------------ | ------------------------- | ---------------- |
| Claude Code | Included in `v0.2.0-rc.3` | Included in `v0.2.0-rc.3` | Supported | Later |
| OpenAI Codex CLI | Included in `v0.2.0-rc.3` | Included in `v0.2.0-rc.3` | Supported | Later |
| Gemini CLI | Read-only in `v0.2.0-rc.3` | No | No | Later |
| OpenCode | Read-only in `v0.2.0-rc.3` | No | No | Later |
...
on macOS and native Windows at `b952d38`. Exact `v0.2.0-rc.3` tagged artifacts
