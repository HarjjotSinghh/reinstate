...
5. Confirm `REINSTATE_HOME` is absolute and writable. `v0.3.0-rc.4`
...
Reinstate and confirm `rein version --json`. For `v0.3.0-rc.4`,
...
### v0.3.0-rc.4: read the environment decision

Stable `v0.2.0` does not include verified resume. In candidate `v0.3.0-rc.4`,
