...
**Gate:** tagged `v0.4.0-rc.7` artifacts complete Claude Code → Codex and Codex
...
*Included in release candidate `v0.4.0-rc.7`. The earlier `v0.4.0-rc.1`
...
| Tagged dual-platform `v0.4.0-rc.7` acceptance | 🚧 |
...
| **Reconstructed conversation** | Reserved and not shipped in `v0.4.0-rc.7` |
