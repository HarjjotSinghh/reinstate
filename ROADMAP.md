...
**Gate:** tagged `v0.4.0` artifacts complete Claude Code → Codex and Codex
...
*Shipped in stable `v0.4.0` after dual-platform tagged-artifact acceptance
PASS on candidate `v0.4.0-rc.11` (Apple Silicon macOS 44/44, native Windows
x64 44/44). The earlier `v0.4.0-rc.1` through `v0.4.0-rc.10` candidates were
published and failed physical acceptance. Native resume remains same-vendor.*
...
| Tagged dual-platform `v0.4.0` acceptance | ✅ |

Gemini CLI, OpenCode, and Grok Build are source-only in `v0.4.0`. Claude Code and
...
| **Reconstructed conversation** | Reserved and not shipped in `v0.4.0` |
